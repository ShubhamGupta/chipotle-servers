...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "shubham-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/chipotle"
  #   chef.validation_client_name = "chipotle-validator"
  #   chef.validation_key_path = ".chef/chipotle-validator.pem"
  # end
end
